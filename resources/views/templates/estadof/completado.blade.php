                            ...
                            <tr>
                                ...
                                <td class="">
                                    <div class="flex justify-center gap-5">
                                        ...
                                        @if ($fact->estado=='COMPLETADO')
                                            <a href="{{route('change.status.fact', ['id'=>$fact->factura_id])}}" type="submit" class="bg-false text-white px-5 py-2 rounded-lg text-sm flex items-center justify-center gap-2 hover:scale-105 duration-300 w-42 font-medium" title="Cambiar a Completado">
